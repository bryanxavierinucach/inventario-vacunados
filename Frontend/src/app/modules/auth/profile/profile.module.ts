...
import { NbActionsModule, NbAlertModule, NbAutocompleteModule, NbBadgeModule, NbButtonModule,
  ...
  NbSelectModule, NbSidebarModule, NbSpinnerModule, NbStepperModule, NbTableModule,
  NbTabsetModule,
  NbToastrModule, NbToggleModule, NbTooltipModule, NbUserModule } from '@nebular/theme';
