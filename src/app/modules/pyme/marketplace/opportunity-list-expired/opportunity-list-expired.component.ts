...
@Component({
  selector: 'ngx-opportunity-list-expired',
  templateUrl: './opportunity-list-expired.component.html',
  styleUrls: ['./opportunity-list-expired.component.scss'],
})
export class OpportunityListExpirededComponent extends LoadDataComponent implements OnInit {
